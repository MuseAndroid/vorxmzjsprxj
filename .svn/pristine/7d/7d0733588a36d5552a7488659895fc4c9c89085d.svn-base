...
public class PushMessageManager extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mCommLibHandle.g_strExtWNIClassPackageName == null) {
            ...
            pubParams.putParam("TARGET_URL", CommonLibHandler.getInstance().g_strHTMLDirForWeb + "www/html/msg.home.html");
